...
graph TD
  ...
  B --> D[Imperative Programming Languages]
  B --> E[Declarative Programming Languages]
```
...
graph TD
	B[Programming languages]
	B --> D[Low-Level Programming
	Languages]
    B --> E[High-Level Programming
	Languages]
    D ----> F[First Generation]
    D ----> V[Second Generation]
    E ----> FF[Third Generation]
    E ----> VV[Fourth Generation]
    E ----> VVV[Fifth Generation]
