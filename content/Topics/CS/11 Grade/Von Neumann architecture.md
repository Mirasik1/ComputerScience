...
## Control Unit 
	 part of the processor that manages the execution of instructions. The CU provides several functions: 
 - it fetches, decodes and executes instructions 
 - it issues control signals that control hardware 
 - it moves data around the system
## Arithmetic Logic Unit 
	part of the processor that performs arithmetic and logic operations.
...
## [[Registers]]
	are small amounts of high-speed memory contained within the CPU. They are used by the processor to store small amounts of data that are needed during processing, such as:
## [[Buses]]
	microscopic parallel wires that transmit data between the processor and other components.
## Clock
	a device that generates signals used to synchronise the components of a computer.
## [[Fetch Execute Cycle]]
